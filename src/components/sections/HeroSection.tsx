    ...
    <section id="about" className="min-h-screen flex items-center">
      <div className="container mx-auto px-6 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y mx-3 animate-slide-in-left self-center">
            <div>
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  ...
                  <a href="mailto:nikita.agarwal208@gmail.com" className="text-portfolio-text-muted hover:text-portfolio-accent transition-all duration-300 hover:scale-110">
                    <svg className="w-6 h-6" viewBox="0 0 45 45" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Right side — Image centered, text left-aligned below */}
          <div className="flex flex-col items-center animate-slide-in-right self-center space-y-6 mt-4">
            <div className="mx-auto">
              <Avatar className="w-48 h-48 hover:scale-105 transition-transform duration-300">
